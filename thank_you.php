...
// Reset the shopping basket arrays when going back to shop page is called
$text .= "
<br />
				...
				<center>
					<table border='0' cellspacing='15' width='100%'>
						<tr>
							<td>
								<center>
									<b>".$thank_you_page_text."</b>
									<br />
									<b><a href='".e_PLUGIN."easyshop/easyshop_basket.php?reset'>".EASYSHOP_THANKS_01."</a></b>
									<br />
									<b><a href='".SITEURL."'>".EASYSHOP_THANKS_02."</a></b>
									<br />
								</center>
							</td>
						</tr>
